...
namespace TheGameProject
{
    ...
    namespace FirstMonoGameApp
    {
        ...
        public class MyFuckingGame : Game
        {
            ...
            Player player;
            private List<IncaTile> incaTile;
            ...
            protected override void Initialize()
            {
                ...
                player = new Player(new Point2(0, Window.ClientBounds.Height / 2),
                                    new Point(50, 50), player.IsAffectedByGravity, player.Velocity, player.JumpMax);
                incaTile = new List<IncaTile>();
                incaTile.Add(new IncaTile(new Point2 { X = 0, Y = Window.ClientBounds.Height - 10 }, new Point(Window.ClientBounds.Width, 10));
